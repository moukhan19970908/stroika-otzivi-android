...
//    val ownPosts = dataViewModel.state.ownPosts.data.mapIndexed { index, item -> item.toPost(index, false)}.reversed()
    val ownPosts = dataViewModel.state.ownPosts.data.mapIndexed { index, item ->
